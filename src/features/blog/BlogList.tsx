    ...
    return (
        <div className='column'>
            ...
            <ul className='blog-list'>
                {blogs.map((val, i) => (
                    <li key={i} data-id={val.id} className='blog-list-item'>
                        <button className='blog-list-button' onClick={handleClickOnBlog}>{val.title}</button>
                        <p className='blog-date' >{val.date}</p>
                    </li>
                ))}
            </ul>
            <br/>
            <button className='primary-button' onClick={() => navigate('create-blog')}>Create a blog</button>
        </div>
    )
}
