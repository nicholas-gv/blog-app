...
const Blog = () => {
    ...
    return (
        <div className='column'>
            ...
            {showEditMode ? (
                <form className='update-content-form' onSubmit={handleUpdateSubmit}>
                    <textarea 
                        id='new-title' 
                        name='new-title' 
                    ...
                    <div className='info-container'>
                        <img src={infoIcon} width="23" className='info-icon'></img>
                    ...
                    <div className='edit-delete-container'>
                        ...
                        <button className='secondary-button' onClick={handleCancelEditButtonClick}>Cancel</button>
                    </div>
                </form>
            ) : (
                <>
                    ...
                    <div className='edit-delete-container'>
                        <button className='primary-button' onClick={()=> setShowEditMode(!showEditMode)}>Edit</button>
                        <button className='delete-button' onClick={() => setShowPopup(true)}>Delete</button>
                    </div>
                </>
            )}
            ...
            { showPopup && (
                <Popup setShowPopup={setShowPopup}>
                    ...
                    <button className='primary-button' onClick={handleDeleteButtonClick}>Yes</button>
                    <button className='secondary-button'>No</button>
                </Popup>
            )}

            { showContextMenu &&
                (<ContextMenu contextMenuPosition={contextMenuPosition} setShowContextMenu={setShowContextMenu}>
                    <button className='secondary-button' onClick={() => formatText("bold")}>Bold</button>
                    <button className='secondary-button' onClick={() => formatText("italic")}>Italic</button>
                    <button className='secondary-button' onClick={() => formatText("underline")}>Underline</button>
                    <button className='secondary-button' onClick={() => formatText("strikethrough")}>Strikethrough</button>
                    <button className='secondary-button' onClick={() => formatText("code")}>Code</button>
                    <button className='secondary-button' onClick={() => formatText("br")}>Break Line</button>
                </ContextMenu>)}
        </div>
    );
}
